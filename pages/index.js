...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-500/50 p-6 dark:border-zinc-500/40">
        ...
        {resume.map((role, roleIndex) => (
          <li key={roleIndex} className="flex gap-4">
            <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
              <img src={role.icon} alt="" className="h-7 w-7" />
            </div>
            <dl className="flex flex-auto flex-wrap gap-x-2">
              ...
              <dd className="text-xs text-zinc-700 dark:text-zinc-200">
                {role.title}
              </dd>
      ...
      <Button href="/resume.pdf" target="_blank" variant="primary" className="group mt-6 w-full">
        Resume
