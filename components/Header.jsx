              ...
              <div className="flex flex-1">
                <div className="pointer-events-auto">
                  ...
                  <button
                    ...
                    className="floating-button group flex flex-row items-center rounded-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 px-4 py-3 shadow-lg shadow-indigo-500/25 backdrop-blur-sm transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/30 hover:scale-105 active:scale-95 border border-white/20"
